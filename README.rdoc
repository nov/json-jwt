...
For details about <code>key</code> and <code>algorithm</code>, see [JWS Spec](https://github.com/nov/json-jwt/blob/master/spec/json/jws_spec.rb) and [SignKeyFixtureHelper](https://github.com/nov/json-jwt/blob/master/spec/helpers/sign_key_fixture_helper.rb).
